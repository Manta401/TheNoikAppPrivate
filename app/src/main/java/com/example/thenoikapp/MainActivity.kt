...
class MainActivity : Activity() {
    ...
    private val myReceiver = ClockReceiver() // i keep trying to make comments with the # instead of //
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Register receiver to fix the clock uwu
        val context = applicationContext
        val intentFilter = IntentFilter("android.intent.action.TIME_TICK")

        ContextCompat.registerReceiver(context, myReceiver, intentFilter, ContextCompat.RECEIVER_EXPORTED)
